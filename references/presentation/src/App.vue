...
const slides: Slide[] = [
  {
    type: 'title',
    heading: 'AI 视频知识助手',
    subheading: '抖音黑客松 · 2026',
    tagline: '让每一个视频都成为可交互的知识入口',
  },
  {
    type: 'overview',
    heading: '产品概览',
    icon: ' ',
    points: [
      { icon: ' ', text: '输入任意视频链接，AI 自动解析内容' },
      { icon: ' ', text: '智能提取关键帧、转录语音、识别主题' },
      { icon: ' ', text: '按领域生成结构化知识卡片' },
      { icon: ' ', text: '支持多轮对话问答，深入理解视频内容' },
    ],
  },
  {
    type: 'pipeline',
    heading: '技术架构',
    steps: [
      { label: '视频下载', icon: '⬇️', detail: 'yt-dlp 多平台支持', color: '#4ecdc4' },
      { label: '关键帧提取', icon: ' ', detail: 'FFmpeg 智能抽帧', color: '#44a3f1' },
      { label: '语音转写', icon: ' ', detail: 'DashScope ASR 毫秒级', color: '#a29bfe' },
      { label: '多模态理解', icon: ' ', detail: 'qwen-vl-max 视觉+文本', color: '#ff6b6b' },
      { label: '知识卡片', icon: ' ', detail: '结构化提取 5 大领域', color: '#ffd93d' },
    ],
  },
  {
    type: 'demo',
    heading: '6 大可组合 Demo',
    demos: [
      { name: '视频解析', desc: '链接→元数据+帧+音频', emoji: ' ', port: '3101' },
      { name: '图片理解', desc: '多模态图片分析', emoji: ' ', port: '3102' },
      { name: '视频摘要', desc: '音频转写+结构化摘要', emoji: ' ', port: '3103' },
      { name: '创意生成', desc: '4 种风格内容创作', emoji: ' ', port: '3104' },
      { name: '视频问答', desc: '多轮对话理解视频', emoji: ' ', port: '3105' },
      { name: '知识卡片', desc: '自动识别领域提取知识', emoji: ' ', port: '3106' },
    ],
  },
  {
    type: 'tech',
    heading: '技术亮点',
    stats: [
      { value: '6', label: '独立 Demo', suffix: '个' },
      { value: '3', label: 'AI 模型', suffix: '路' },
      { value: '<3', label: '秒首帧响应', suffix: 's' },
      { value: '5', label: '知识领域', suffix: '类' },
    ],
    highlights: [
      '模块化架构：赛前备好零件，当天快速组装',
      '纯 Node.js/TS 技术栈，无 Python 依赖',
      '国内 AI 服务：通义千问 + DashScope 全链路',
      '前后端分离：Vue 3 + Hono，轻量高效',
    ],
  },
  {
    type: 'team',
    heading: '团队成员',
    members: [
      { name: '待填写', role: '队长 · 全栈开发', avatar: ' ', bio: '统筹技术架构与产品方向', color: '#ff6b6b', accent: '#ff4444' },
      { name: '待填写', role: '前端开发', avatar: ' ', bio: 'UI 交互与可视化展示', color: '#4ecdc4', accent: '#00d2d3' },
      { name: '待填写', role: 'AI 算法', avatar: ' ', bio: 'Prompt 工程与模型调优', color: '#ffd93d', accent: '#f9ca24' },
      { name: '待填写', role: '产品设计', avatar: ' ', bio: '产品策划与路演展示', color: '#a29bfe', accent: '#6c5ce7' },
    ],
  },
  {
    type: 'cta',
    heading: 'Thank You',
    subheading: 'AI 视频知识助手',
    tagline: '让每一个视频都成为可交互的知识入口',
    qrText: '扫码体验 Demo',
  },
]
    ...
    <TransitionGroup :name="direction > 0 ? 'slide-forward' : 'slide-backward'">
      <div v-for="(slide, index) in slides" v-show="index === current" :key="index" class="slide">
        ...
        <div v-if="slide.type === 'title'" class="slide-content title-slide">
          ...
          <h1 class="main-title glitch" data-text="AI 视频知识助手">
